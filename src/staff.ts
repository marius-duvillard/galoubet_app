 ...
 */
export const CLEF_SCALE = 16 / 2246.8;
export const CLEF_TRANSFORM = `translate(${(-375.8 * CLEF_SCALE).toFixed(3)} ${(48 - 7776 * CLEF_SCALE).toFixed(3)}) scale(${CLEF_SCALE.toFixed(6)}) matrix(3.817349,0,0,3.808092,-3380.452,-23251.63)`;
